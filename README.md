...
iOS: Logout call back message and set signoutFromBrowser = true to signout from browser or webview
Android: Logout call back message 

Thanks @recognizebv/capacitor-plugin-msauth and for updated library follow https://github.com/recognizegroup/capacitor-plugin-msauth.git

[Vipin Patil - Mayur Pardeshi - Shubham Kasar]
